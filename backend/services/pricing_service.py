...
class PricingService:
    ...
    async def schedule_price_change(
        ...
        pricing = FuelPricing(
            pricing_id=f"RURA-{datetime.utcnow().strftime('%Y%m')}-{rura_ref}",
            fuel_type=fuel_type,
